...
export default function SignupPage() {
    ...
    const handleSignup = async (e) => {
        ...
        // 1. Sign up with Supabase Auth, passing metadata so the trigger can use it
        ...
        // 2. If email confirmation is disabled, session is ready — redirect now
        if (authData.session) {
            const redirectPath = getLandingForRole(role);
